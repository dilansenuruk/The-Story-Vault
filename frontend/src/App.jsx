...
//               <div className="flex-1 rounded-[28px] border border-blue-100 bg-gradient-to-br from-white to-blue-50 p-8 shadow-inner overflow-auto">

//                 <div className="text-slate-700 text-xl leading-10 whitespace-pre-wrap">
//                   {loading
